...
get_details(parameter_set_id=None)
...
get_id_by_name(parameter_set_name)
...
update(parameter_set_id, new_data, file_path)
...
class metanames.ParameterSetsMetaNames
...
ibm_watsonx_ai.parameter_sets Source Code [FOR REFERENCE ONLY, DO NOT ATTEMPT TO EDIT, INCLUDE CHANGES TO, ETC. WORK WITHIN ITS CONSTRAINTS.]
